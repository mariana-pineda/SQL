-- Set up the environment and create table for testing
-- Using Unity Catalog purgo_databricks with Schema purgo_playground
...
-- Insert test data into f_order table for validation
