...
# Try-except block to handle table drop operation
try:
...
# Try-except block to handle table creation operation
try:
...
# Try-except block to perform data masking on invoice_number
try:
