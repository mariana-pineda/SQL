...
# Validation code
def validate_model_performance(expected_accuracy, actual_accuracy, dataset_type):
    assert np.isclose(expected_accuracy, actual_accuracy, atol=0.05), \
        f"{dataset_type} accuracy validation failed. Expected: {expected_accuracy}, Actual: {actual_accuracy}"

# Expected accuracies (hypothetical values for demonstration)
expected_validation_accuracy = 0.75
expected_test_accuracy = 0.75

# Validate the model performance
validate_model_performance(expected_validation_accuracy, validation_accuracy, "Validation")
validate_model_performance(expected_test_accuracy, test_accuracy, "Test")
